...
public class InicioCorredores extends javax.swing.JDialog {
    ...
    /**
     * Creates new form InicioCorredores
     */
    public InicioCorredores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioCorredores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InicioCorredores dialog = new InicioCorredores(new javax.swing.JFrame(), true);
