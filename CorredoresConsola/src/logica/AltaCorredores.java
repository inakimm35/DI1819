...
public class AltaCorredores extends javax.swing.JDialog {
     ...
     */
    public AltaCorredores(java.awt.Frame parent, boolean modal,List<Corredor> corredoresParametro) {
        super(parent, modal);
        initComponents();
        this.corredores=corredoresParametro;
    }
    ...
    private void jButtonValidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValidarActionPerformed
        ...
        corredores.add(new Corredor (dni, nombre, apellidos, fecha, direccion, telefono));
        this.dispose();
